...
path_3D_1 = [[wd/2-dia/2, wd/2-dia/2, 2], [wd/2-dia/2, wd/2-dia/2, 30], [40/2-8, 40/2-8, 86]];
ramen(path_3D_1, diameter=dia, circle_steps=20);
translate([wd/2-dia/2,wd/2-dia/2,2]) cylinder(28.5,d=dia);
path_3D_2 = [[-(wd/2-dia/2), -(wd/2-dia/2), 2], [-(wd/2-dia/2), -(wd/2-dia/2), 30], [-(40/2-8), -(40/2-8), 86]];
ramen(path_3D_2, diameter=dia, circle_steps=20);
translate([-(wd/2-dia/2),-(wd/2-dia/2),2]) cylinder(28.5,d=dia);
path_3D_3 = [[(wd/2-dia/2), -(wd/2-dia/2), 2], [(wd/2-dia/2), -(wd/2-dia/2), 30], [(40/2-8), -(40/2-8), 86]];
ramen(path_3D_3, diameter=dia, circle_steps=20);
translate([(wd/2-dia/2),-(wd/2-dia/2),2]) cylinder(28.5,d=dia);
path_3D_4 = [[-(wd/2-dia/2), (wd/2-dia/2), 2], [-(wd/2-dia/2), (wd/2-dia/2), 30], [-(40/2-8), (40/2-8), 86]];
ramen(path_3D_4, diameter=dia, circle_steps=20);
translate([-(wd/2-dia/2),(wd/2-dia/2),2]) cylinder(28.5,d=dia);

difference() {
    translate([0,0,2]) cube([wd,wd,4],true);
    cylinder(4,d=85);
}
difference() {
    translate([0,0,86]) cylinder(h=6,d=40);
    translate([0,0,86]) cylinder(h=6,d=29);
}
